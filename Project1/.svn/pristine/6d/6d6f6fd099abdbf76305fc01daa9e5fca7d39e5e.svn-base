    ...
    public class FlexValueCategoryController : BaseController
    {
        ...
        public ActionResult GetAllByPage(ModelSearchFelexValue modelSearch)
        {
            ...
            try
            {
                ...
                AddLog("Lấy dữ liệu theo trang bảng Danh mục Nhóm/Loại( keyword: " + modelSearch.KeyWord + ", page: " + modelSearch.currentPage + ") thành công.");
            ...
            catch (Exception ex)
            {
                ...
                AddLog("Lấy dữ liệu theo trang bảng Danh mục Nhóm/Loại( keyword: " + modelSearch.KeyWord + ", page: " + modelSearch.currentPage + ") lỗi: " + ex.Message);
                return Json(obj);
            }
        }
        ...
        public ActionResult GetBottomAction()
        {
            ...
            try
            {
                ...
                return Json(new { FlexValueSets = flexValueSets, FlexValueColumns = flexValueColumns, Buttoms = bottoms, Error = false, Title = "Lấy dữ liệu thành công." }); ;
            }
            catch (Exception ex)
            {
                obj.Error = true;
        ...
        public ActionResult GetDanhMuc()
        {
            ...
            try
            {
                ...
                var flexValueParents = new List<LT_FLEX_VALUE_CATEGORIES>();

                flexValueParents.AddRange(_flexValueCategoryDA.GetAll());
        ...
        public object GetItemByID(int Id)
        {
            try
            {
                ...
                return Json(new
                {
                    ...
                    FlexValueColumns = flexValueColumns,
                    FlexValueParents = flexValueParents,
                    Error = false, Title = "Lấy dữ liệu thành công.", data = data });
            }
            catch (Exception ex)
            {
