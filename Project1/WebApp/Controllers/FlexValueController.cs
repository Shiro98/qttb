    ...
    public class FlexValueController : BaseController
    {
        ...
        public ActionResult GetAllByPage(ModelSearchFelexValue modelSearch)
        {
            ...
            try
            {
                ...
                AddLog("Lấy dữ liệu theo trang bảng Danh mục( FLEX_VALUE_SET_ID: " + modelSearch.FLEX_VALUE_SET_ID + ", page: " + modelSearch.currentPage + ") thành công.");
            ...
            catch (Exception ex)
            {
                ...
                AddLog("Lấy dữ liệu theo trang bảng Danh mục( FLEX_VALUE_SET_ID: " + modelSearch.FLEX_VALUE_SET_ID + ", page: " + modelSearch.currentPage + ") lỗi: " + ex.Message);
                return Json(obj);
            }
        }
        ...
        public ActionResult GetBottomAction()
        {
            ...
            try
            {
                ...
                var flexValueColumns = _flexValueCateDA.GetColumn(flexValueSets.FirstOrDefault().FLEX_VALUE_SET_ID);
                ...
                return Json(new { 
                    ...
                    Error = false, Title = "Lấy dữ liệu thành công." }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
                obj.Error = true;
        ...
        public ActionResult GetColumnByFlexValueSet(int flexValueSetId)
        {
            ...
            try
            {
                var flexValueColumns = _flexValueCateDA.GetColumn(flexValueSetId);
        ...
        [HttpPost]
        public ActionResult GetDanhMuc(int flexValueSetId)
        {
            ObjectMessage obj = new ObjectMessage
            {
                Error = false
        ...
        public object GetItemByID(int Id)
        {
            try
            {
                ...
                var flexValueColumns = _flexValueCateDA.GetColumn(data.FLEX_VALUE_SET_ID);

                AddLog("Lấy dữ liệu theo ID bảng Danh mục(ID: " + Id + ") thành công.");
                return Json(new {  FlexValueColumns = flexValueColumns, Error = false, Title = "Lấy dữ liệu thành công.", data = data }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
